...
const sampleDropdownOptions = [
  ...
  {
    key: '4',
    text: 'Super long long super long Super long long super long',
    value: 'Third'
  }
]
    ...
    <div style={{ width: '300px' }}>
      <Message color="green">
        ...
        <p>
          ...
          tristique odio viverra eros interdum luctus. Pellentesque consectetur
          tortor id dictum blandit.
        </p>
      </Message>
    </div>
  ))
  .add('green against dark', () => (
    <Segment inverted>
      <div style={{ width: '300px' }}>
        <Message color="green">
          <Message.Header>Header</Message.Header>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
            tristique odio viverra eros interdum luctus. Pellentesque
            consectetur tortor id dictum blandit.
          </p>
        </Message>
      </div>
    </Segment>
...
storiesOf('Input', module)
  ...
  .add('inverted error', () => (
    <div>
      <Segment inverted>
        <Input
          className="input-inverted error"
          inverted
      ...
      <Form>
        <Form.Field>
          <Input
            placeholder="Placeholder"
            value="value"
            input={{ autoFocus: true, select: true }}
          />
        </Form.Field>
        <Form.Field>
    ...
    <div style={{ width: '300px' }}>
      <Segment inverted>
        <Form inverted>
          ...
          <Form.Field error>
            <TextArea
              style={{ borderColor: 'red', backgroundColor: '#1b1c1d' }}
              placeholder="Placeholder"
            />
          </Form.Field>
        </Form>
    ...
    <Segment inverted>
      <div style={{ borderBottom: 'solid 1px lightgrey', padding: '5px' }}>
        <Menu secondary inverted>
          ...
          <Menu.Menu position="right">
            <Menu.Item>
              <Input className="input-inverted" inverted />
            </Menu.Item>
...
storiesOf('Grid', module).add('compact', () => (
  <Segment>
    <Grid>
      <Grid.Row>
